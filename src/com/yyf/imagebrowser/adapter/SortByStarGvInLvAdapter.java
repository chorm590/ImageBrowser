...
public class SortByStarGvInLvAdapter extends BaseAdapter {
	protected LayoutInflater mInflater;
	private List<ImageEntity> list;

	public SortByStarGvInLvAdapter(Context cn, List<ImageEntity> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		Log.v("mylog", "sortbystargvinlvadapter.getview."+position);
